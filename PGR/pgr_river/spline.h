...
extern glm::vec3 fishCurveData[];
extern const size_t  fishCurveSize;

extern glm::vec3 droneCurveData[];
extern const size_t  droneCurveSize;
...
//**************************************************************************************************
/// Evaluates a fist derivative of Coons curve segment.
/**
  \param[in] P0       First control point of the curve segment.
  \param[in] P1       Second control point of the curve segment.
  \param[in] P2       Third control point of the curve segment.
