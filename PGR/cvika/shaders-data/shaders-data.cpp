...
// ======== BEGIN OF SOLUTION - TASK 1-1 ======== //
  ...
  glVertexAttribPointer(handles.position, 3, GL_FLOAT, GL_FALSE, 0, (void *)(state.frame * birds_data.nVertices * 3 * sizeof(float)));
...
// ======== BEGIN OF SOLUTION - TASK 3-4 ======== //
  ...
  glVertexAttribPointer(handles.nextPosition, 3, GL_FLOAT, GL_FALSE, 0, (void*)(state.nextFrame * birds_data.nVertices * 3 * sizeof(float)));
...
// ======== BEGIN OF SOLUTION - TASK 1-2 ======== //
  ...
  glDrawElements(GL_TRIANGLES, birds_data.nFaces * 3, GL_UNSIGNED_SHORT, 0);
...
// ======== BEGIN OF SOLUTION - TASK 3-5 ======== //
  ...
  handles.nextPosition = glGetAttribLocation(resources.program, "aNextPosition");
...
// ======== BEGIN OF SOLUTION - TASK 1-3 ======== //
  ...
  glVertexAttribPointer(handles.position, 3, GL_FLOAT, GL_FALSE, 0, 0);
// ========  END OF SOLUTION - TASK 1-3  ======== //

// ======== BEGIN OF SOLUTION - TASK 3-6 ======== //
  // enable and initialize the nextPosition attribute array 
  glEnableVertexAttribArray(handles.nextPosition);
  glVertexAttribPointer(handles.nextPosition, 3, GL_FLOAT, GL_FALSE, 0, 0);
